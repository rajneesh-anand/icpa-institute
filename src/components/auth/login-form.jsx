      ...
      <div className="flex bg-fill mx-auto rounded-lg overflow-hidden">
        ...
        <div className="w-full md:w-[45%] xl:w-[40%] py-6 sm:py-10 px-4 sm:px-8 xl:px-12 rounded-md shadow-dropDown flex flex-col justify-center">
          <div className="text-center mb-6 ">
            ...
            <div className="text-sm sm:text-[15px] text-center mt-3 mb-1">
              Don't have an account ?
              <button
                type="button"
                className="text-primary sm:text-15px text-sm ml-1  font-medium hover:no-underline focus:outline-none"
          ...
          >
            ...
            <div className="flex flex-col space-y-3.5">
              ...
              <div className="relative">
                <button
                  type="submit"
                  className="inline-flex items-center justify-center w-full  px-4 py-2 text-base font-medium leading-6 text-white whitespace-no-wrap bg-primary rounded-sm shadow-sm focus:outline-none hover:bg-opacity-90"
                >
                  Sign In
                </button>
              </div>
          ...
          <div className="text-center mt-2">
            <button
              className="text-teal-900 text-[15px]"
              type="button"
          ...
          <div>
            <p className="mt-2 px-2 text-center text-[14px] text-teal-600">
              By signing in, you agree to ICPA Institute
              <span
                onClick={() => handleNavigate("terms")}
                className="mx-1 cursor-pointer text-primary underline hover:no-underline"
              >
                terms
              </span>
              &amp;{" "}
              <span
                ...
                className="cursor-pointer text-primary underline hover:no-underline ltr:ml-1 rtl:mr-1"
              >
                policy
              </span>
            </p>
