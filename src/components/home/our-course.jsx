    ...
    <Container className="my-16">
      ...
      <div className="flex items-center justify-center py-8">
        <button
          ...
          className="text-white bg-orange hover:bg-orange/75 focus:ring-2 focus:ring-[#431d48] font-medium rounded-sm text-lg px-8 py-2 text-center inline-flex items-center  mr-2 mb-2"
        >
          All
        </button>
        <button
